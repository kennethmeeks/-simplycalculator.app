...
export const Home: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>All Online Calculators 2026 | 1300+ Free Tools | simplycalculator.app</title>
        <meta name="description" content="Access over 1300+ free online calculators for 2026. Organized tools for Finance, Health, Math, Construction, Tech, and more. Accurate formulas and easy-to-use interfaces." />
        ...
        <section className="bg-[#111] text-white p-12 sm:p-20 shadow-[20px_20px_0px_0px_rgba(37,99,235,1)] relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 text-[10px] font-black uppercase tracking-[0.2em] text-blue-500">
                <span className="bg-white/5 px-3 py-1 border border-white/10">1300+ Specialized Tools</span>
