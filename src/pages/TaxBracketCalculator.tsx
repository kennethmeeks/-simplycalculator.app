          ...
          <div className="calculator-container bg-slate-900 text-white">
            ...
            <div className="space-y-6">
              <div className="text-center py-4 border-b border-slate-800">
                <div className="text-4xl font-bold mb-1">${totalTax.toLocaleString()}</div>
                <div className="text-xs font-medium text-slate-400 uppercase tracking-wider">Total Federal Tax</div>
              </div>
              <div className="grid grid-cols-2 gap-4 text-center py-4">
                <div>
                  <div className="text-xl font-bold text-slate-200">{marginalRate}%</div>
                  <div className="text-[10px] text-slate-400 uppercase font-bold">Marginal Rate</div>
                </div>
                <div>
                  <div className="text-xl font-bold text-slate-200">{effectiveRate}%</div>
                  <div className="text-[10px] text-slate-400 uppercase font-bold">Effective Rate</div>
                </div>
              </div>
            </div>
          </div>
