  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content={`Solve your ${data.title} questions with our full suite of 1,900+ verified tools. Accurate, instant results for professionals and students.`} />
