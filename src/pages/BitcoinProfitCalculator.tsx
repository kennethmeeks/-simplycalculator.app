...
export const BitcoinProfitCalculator: React.FC = () => {
  ...
  const [btcOwned, setBtcOwned] = useState<number>(0);

  useEffect(() => {
    const buyFeeAmount = investmentAmount * (investmentFee / 100);
    const netInvestment = investmentAmount - buyFeeAmount;
    const btc = netInvestment / buyPrice;
    
    const grossValue = btc * sellPrice;
    ...
    setBtcOwned(Number(btc.toFixed(8)));
  }, [investmentAmount, buyPrice, sellPrice, investmentFee, exitFee]);

  return (
    <div className="max-w-4xl mx-auto">
      <Helmet>
        <title>Bitcoin Profit Calculator | Calculate Your BTC ROI</title>
        <meta name="description" content="Free online bitcoin profit calculator. Calculate your total profit, percentage gain, and amount of BTC owned for any investment." />
      </Helmet>

      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Bitcoin Profit Calculator</h1>
        <p className="text-slate-600">Calculate the potential profit or loss on your Bitcoin investments, including exchange fees.</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded p-6">
            ...
            <ul className="text-slate-600 text-sm space-y-3 list-disc pl-4">
              <li><strong>Bitcoin (BTC):</strong> The first and most popular decentralized cryptocurrency.</li>
              <li><strong>Exchange Fees:</strong> Most exchanges charge a fee for both buying and selling (usually 0.1% to 1.5%).</li>
              <li><strong>Volatility:</strong> Bitcoin prices can fluctuate wildly in a very short time.</li>
              <li><strong>Taxes:</strong> Bitcoin is treated as property for tax purposes in many countries, meaning you'll owe capital gains tax on profits.</li>
          ...
          <div className="calculator-container bg-[#f0f7ff] border border-[#0066cc]/20 text-[#0066cc]">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-center py-4 border-b border-[#0066cc]/10">
                ...
                <div>
                  <div className="text-xl font-bold text-[#0066cc] truncate px-2">{btcOwned}</div>
                  <div className="text-[10px] text-slate-500 uppercase font-bold">BTC Owned</div>
                </div>
              </div>
