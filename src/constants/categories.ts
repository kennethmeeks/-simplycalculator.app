...
export const CATEGORIES: CategoryData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Eigenvalue & Eigenvector', path: '/math/eigen-calculator', desc: 'Calculate core scaling and direction factors.', keywords: ['eigen decomposition', 'linear transformations', 'matrix analysis'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ABSI Calculator', path: '/absi-calculator', desc: 'Body Shape Index for mortality risk.', keywords: ['a body shape index', 'absi', 'mortality risk', 'abdominal fat', 'waist circumference health', 'body shape health', 'visceral fat', 'health risk assessment', 'metabolic risk', 'body metrics', 'longevity calculator', 'clinical health', 'central obesity', 'risk indicator'] },
      ...
      { name: 'Body Shape', path: '/body-shape-calculator', desc: 'Identify your silhouette type.', keywords: ['hourglass', 'pear shape', 'apple shape', 'rectangle body', 'inverted triangle', 'silhouette analysis', 'body measurements', 'fashion fit', 'styling guide', 'physique type', 'female body shape', 'male body shape', 'waist hip ratio', 'bust waist hip'] },
      { name: 'BRI Calculator', path: '/bri-calculator', desc: 'Body Roundness Index for health tracking.', keywords: ['body roundness index', 'bri', 'metabolic health', 'waist to height', 'physical fitness', 'body shape index', 'obesity risk', 'cardiovascular health', 'body proportions', 'health indicator', 'abdominal fat', 'visceral wellness', 'bri vs bmi'] },
      { name: 'BSA Calculator', path: '/bsa-calculator', desc: 'Body Surface Area for clinical dosing.', keywords: ['body surface area', 'bsa', 'clinical pharmacology', 'medical dosing', 'drug dose calculation', 'oncology math', 'surface area', 'burn assessment', 'renal function', 'cardiac output', 'physics medicine', 'du bois formula', 'mosteller formula'] },
      { name: 'FFMI Calculator', path: '/ffmi-calculator', desc: 'Fat-Free Mass Index for muscularity.', keywords: ['fat free mass index', 'ffmi', 'muscularity', 'natural vs enhanced', 'bodybuilding math', 'lean muscle index', 'muscle mass', 'athletic performance', 'fat free weight', 'physique assessment', 'genetic potential', 'fitness modeling', 'lean body mass'] },
      ...
      { name: 'RFM Calculator', path: '/rfm-calculator', desc: 'Relative Fat Mass for body composition.', keywords: ['relative fat mass', 'rfm', 'body fat estimation', 'bmi alternative', 'waist height ratio', 'fat percentage', 'composition analysis', 'health metrics', 'body fat index', 'metabolic health', 'obesity tracking', 'physical fitness', 'body metrics'] },
      ...
      { name: 'BEE Calculator', path: '/bee-calculator', desc: 'Basal Energy Expenditure analysis.', keywords: ['basal energy expenditure', 'bee', 'metabolic rate', 'harris benedict', 'energy physics', 'resting calories', 'biological fuel', 'human metabolism', 'energy budget', 'calorie needs', 'clinical nutrition', 'dietetics'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'A1c to Glucose', path: '/a1c-calculator', desc: 'Convert Hemoglobin A1c to average blood sugar.', keywords: ['hemoglobin a1c', 'estimated average glucose', 'eag', 'diabetes tracking', 'sugar average', '3 month sugar', 'hba1c conversion', 'blood glucose average', 'diabetic monitoring', 'clinical a1c'] },
      ...
      { name: 'QUICKI Calculator', path: '/quicki-calculator', desc: 'Quantitative Insulin Sensitivity Check Index.', keywords: ['insulin sensitivity', 'quicki', 'homa ir alternative', 'insulin resistance', 'metabolic health', 'glucose sensitivity', 'clinical indicators', 'endocrinology', 'medical research', 'insulin index'] },
      ...
      { name: 'LDL Calculator', path: '/ldl-calculator', desc: 'Estimate Low-Density Lipoprotein levels.', keywords: ['bad cholesterol', 'low density lipoprotein', 'ldl c', 'friedewald formula', 'lipid profile', 'heart health', 'cholesterol math', 'ldl estimation', 'cardiovascular risk', 'lipids'] },
      { name: 'VLDL Calculator', path: '/vldl-calculator', desc: 'Analyze Very Low-Density Lipoprotein.', keywords: ['triglycerides', 'vldl', 'very low density lipoprotein', 'lipid profile', 'heart health', 'lipids', 'vldl estimation', 'blood chemistry', 'cardiovascular risk', 'metabolic health'] },
      { name: 'SAAG Score', path: '/saag-calculator', desc: 'Serum-Ascites Albumin Gradient for clinical diagnostics.', keywords: ['ascites', 'liver disease', 'portal hypertension', 'albumin gradient', 'hepatology', 'clinical diagnostics', 'medical math', 'liver cirrhosis', 'internal medicine', 'saag math'] },
      ...
      { name: 'AHI Calculator', path: '/ahi-calculator', desc: 'Apnea-Hypopnea Index for sleep studies.', keywords: ['sleep apnea', 'ahi', 'cpap', 'sleep study', 'polysomnography', 'hypopnea', 'snoring', 'sleep disorders', 'respiratory math', 'oxygen saturation'] },
  ...
  },
  {
    ...
    items: [
      { name: 'ACFT Calculator', path: '/acft-calculator', desc: 'Army Combat Fitness Test grading.', keywords: ['acft scoring', 'army fitness', 'strength test', 'deadlift', 'power throw', 'army pt', 'leg tuck', 'shuttle run', 'combat fitness', 'grading scale', 'physical assessment', 'military health', 'standards', 'exercise math'] },
      { name: 'APFT Calculator', path: '/apft-calculator', desc: 'Legacy Army Physical Fitness Test scoring.', keywords: ['army physical fitness', 'apft', 'legacy army pt', 'pushups and situps', 'two mile run', 'pt test scoring', 'army standards', 'vintage army fitness', 'physical training', 'score chart', 'army metrics', 'military exercise'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Newton Meter', path: '/nm-calculator', desc: 'Calculate torque from force and distance.', keywords: ['newton meters', 'torque calculation', 'moment of force', 'lever arm math', 'mechanical advantage', 'torque physics', 'physics homework torque', 'engineering mechanics', 'Nm calculator', 'force times distance'] },
      ...
      { name: 'Degrees Min Sec (DMS)', path: '/dms-calculator', desc: 'Precise geographic positioning.', keywords: ['degrees minutes seconds', 'dms', 'geographic coordinates', 'mapping math', 'navigation', 'cartography', 'geographic positioning', 'precise location', 'coordinate formatting', 'longitude latitude'] },
      ...
      { name: 'Scale Calculator', path: '/scale-calculator', desc: 'Model and map ratio conversions.', keywords: ['map scale', 'model ratios', 'scale factor', 'architectural scale', 'miniature models', 'ratio converter', 'drawing scale', 'engineering drawing', 'map units', 'scale math'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Brake Horsepower', path: '/bhp-calculator', desc: 'True engine power without auxiliary losses.', keywords: ['bhp calculator', 'brake horsepower', 'engine power', 'crank horsepower', 'net power', 'automotive engineering', 'dyno math', 'performance tuning', 'engine stats', 'mechanical output', 'flywheel power', 'industrial engines', 'horsepower formula'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ERA Calculator', path: '/era-calculator', desc: 'Earned Run Average for pitchers.', keywords: ['earned run average', 'era', 'pitching stats', 'sabermetrics', 'baseball pitching', 'pitching performance', 'pitching math', 'earned runs', 'innings pitched', 'mlb pitching metrics', 'pitcher analytics'] },
      ...
      { name: 'FIP Calculator', path: '/fip-calculator', desc: 'Fielding Independent Pitching measurement.', keywords: ['fip', 'pitching analytics', 'sabermetrics', 'baseball stats advanced', 'pitching evaluation', 'pitching vs defense', 'fielding independent pitching', 'mlb advanced metrics', 'pitcher performance'] },
      { name: 'Magic Number', path: '/magic-number-baseball', desc: 'Track playoff clinching scenarios.' },
      { name: 'On Base Percentage', path: '/obp-calculator', desc: 'Calculate total ability to reach base.', keywords: ['on base percentage', 'obp', 'baseball stats', 'sabermetrics', 'hitting stats pro', 'walks and hits', 'getting on base', 'on base analytics', 'baseball math', 'mlb metrics', 'obp calculation'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Birthday', path: '/birthday-calculator', desc: 'Countdown to your next celebration.', keywords: ['countdown', 'special day', 'age milestones', 'birth date'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Ping (Latency) Math', path: '/ping-calculator', desc: 'Calculate the physical delay in online matches.', keywords: ['networking', 'latency', 'lag', 'esports'] },
      ...
      { name: 'RPG XP Curve', path: '/xp-calculator', desc: 'Estimate kills needed for next level.', keywords: ['rpg', 'mmo', 'experience points', 'leveling'] },
      { name: 'DPI to eDPI', path: '/edpi-calculator', desc: 'Standardize mouse sensitivity across systems.', keywords: ['mouse sensitivity', 'gaming metrics', 'fps tuning'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Nap Schedule', path: '/nap-time-calculator', desc: 'Find the best sleep windows for infants.', keywords: ['baby sleep', 'routine', 'parenting'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Child Support Estimator', path: '/child-support-calculator', desc: 'Standard formula based on income.', keywords: ['family law', 'divorce', 'custody finance'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Staking Rewards (APY)', path: '/staking-calculator', desc: 'Project yield from locked assets.', keywords: ['passive income', 'pos', 'blockchain yield'] },
      ...
      { name: 'HODL Value Tracker', path: '/hodl-calculator', desc: 'Visualize long term holding power.', keywords: ['psychology', 'investing', 'diamond hands'] },
  ...
  },
  {
    ...
    items: [
      { name: 'Freelance Hourly Rate', path: '/hourly-rate-calculator', desc: 'Reclaim your worth: include tax and overhead.', keywords: ['business strategy', 'pricing', 'career growth'] },
      ...
      { name: 'Upwork vs Fiverr Fees', path: '/platform-fee-calculator', desc: 'Project net take-home from marketplaces.', keywords: ['gig economy', 'freelancing', 'fees'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Economic Order Quantity', path: '/eoq-calculator', desc: 'Balance holding vs ordering costs.', keywords: ['inventory theory', 'optimum', 'business math'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'House Flipping ROI', path: '/flip-calculator', desc: 'Buy, reno, and carry cost analysis.', keywords: ['business', 'real estate', 'finance'] },
      ...
      { name: 'BRRRR Strategy', path: '/brrrr-calculator', desc: 'Refinance and repeat investment math.', keywords: ['finance', 'investment', 'real estate'] },
  ...
  },
  {
    ...
    items: [
      { name: 'Depth of Field (DoF)', path: '/dof-calculator', desc: 'Find the hyperfocal distance for sharp landscapes.', keywords: ['photography', 'optics', 'tech'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '0-60 Time Simulator', path: '/accel-est-calculator', desc: 'Weight-to-power ratio estimates.', keywords: ['automotive', 'racing', 'tech'] },
    ]
  },
  {
    ...
    items: [
      ...
      { name: 'Daily Light Integral', path: '/plant-dli-calculator', desc: 'Photoperiod vs PPFD for grow light timing.', keywords: ['nature', 'tech', 'science'] },
  ...
  },
  {
    ...
    items: [
      { name: 'True Airspeed (TAS)', path: '/tas-calculator', desc: 'Correct IAS for pressure altitude and temp.', keywords: ['aviation', 'physics', 'travel'] },
